...
public interface SitCenterWebhookProtocolDecisionProjection {
    ...
    String getViolatorGender();

    LocalDateTime getViolationTime();

    String getInspectorFio();

    LocalDate getInspectorBirthdate();
    String getViolatorIntoxicationName();
    Long getViolatorIntoxicationId();
    Long getViolatorActualAddressRegionId();
    Long getViolatorActualAddressDistrictId();
