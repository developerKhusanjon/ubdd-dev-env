package uz.ciasev.ubdd_service.repository.replica;

import org.springframework.data.jpa.repository.JpaRepository;
import org.springframework.data.jpa.repository.Query;
import org.springframework.data.repository.query.Param;
import uz.ciasev.ubdd_service.entity.replica.ReplicaWebhookEvent;
import uz.ciasev.ubdd_service.entity.replica.ReplicaWebhookProtocolDecisionProjection;

import java.util.List;

public interface ReplicaWebhookEventRepository extends JpaRepository<ReplicaWebhookEvent, Long> {
    ...
    List<ReplicaWebhookProtocolDecisionProjection> getProjectionsByProtocolId(@Param("ids") Iterable<Long> ids);
}
